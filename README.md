...
|:----------|:---|
|• React 프론트엔드 개발<br>• Proxy 서버 구축<br>• CORS 구현<br>• Postgresql  데이터베이스 구축<br>• Fast API 백엔드 개발<br>• Docker 배포| • Figma 작성<br>• 데이터 분석 및 전처리, AI (분류, 세그멘테이션) 모델 개발<br>• AI 모델 배포용 Flask 기반 Rest API 개발<br>• PythonAnywhere 배포|
